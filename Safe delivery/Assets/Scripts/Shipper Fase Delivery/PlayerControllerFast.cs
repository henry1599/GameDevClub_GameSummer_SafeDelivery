...
public class PlayerControllerFast : MonoBehaviour
{
    ...
    private static PlayerControllerFast instance;

    public static PlayerControllerFast Instance { get => instance; set => instance = value; }
    ...
    void Update()
    {
        ...
        {
            FindObjectOfType<AudioManager>().Play("Super jump");
        ...
        if (ShareVariablesFast.IS_USING_ABILITY == true)
        {
            ...
            Instantiate(energyDropPrefab, energyBar.transform.position, Quaternion.identity);
            ShareVariablesFast.CURRENT_ENERGY = Mathf.Clamp(ShareVariablesFast.CURRENT_ENERGY, 0, ShareVariablesFast.MAX_ENERGY);
