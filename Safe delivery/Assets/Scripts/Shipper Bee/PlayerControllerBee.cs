...
public class PlayerControllerBee : MonoBehaviour
{
    ...
    private static PlayerControllerBee instance;
    public GameObject energyDropPrefab;

    public static PlayerControllerBee Instance { get => instance; set => instance = value; }
    ...
    void Update()
    {
        ...
        if (ShareVariablesBee.IS_USING_ABILITY == true)
        {
            ...
            ShareVariablesBee.CURRENT_ENERGY = Mathf.Clamp(ShareVariablesBee.CURRENT_ENERGY, 0, ShareVariablesBee.MAX_ENERGY);
