...
public class PlayerControllerShopee: MonoBehaviour
{
    ...
    private static PlayerControllerShopee instance;
    public GameObject energyDropPrefab;

    public static PlayerControllerShopee Instance { get => instance; set => instance = value; }
    ...
    void Update()
    {
        ...
        if (ShareVariables.IS_USING_ABILITY == true)
        {
            ...
            ShareVariables.CURRENT_ENERGY = Mathf.Clamp(ShareVariables.CURRENT_ENERGY, 0, ShareVariables.MAX_ENERGY);
